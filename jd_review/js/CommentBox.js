function CommentBox(){
	...
	this.pn = new PageNavigator(function(number){
		// number表示的是navigation里的形参callback:此刻在这里的作用是
		//让大组件的当前页改变
		self.page = number;
...
CommentBox.prototype.changeScore = function( scoreNumber){
	// scorenumber指的是此刻随机传入的eqidx的一个值
	// 后面的score指的是之后获得的scoreNumber的那个值
